...
namespace Common\Plugin\Imagine\Imagick;

use Common\Plugin\Imagine\Exception\OutOfBoundsException;
use Common\Plugin\Imagine\Exception\InvalidArgumentException;
use Common\Plugin\Imagine\Exception\RuntimeException;
use Common\Plugin\Imagine\Image\AbstractImage;
use Common\Plugin\Imagine\Image\Box;
use Common\Plugin\Imagine\Image\BoxInterface;
use Common\Plugin\Imagine\Image\Metadata\MetadataBag;
use Common\Plugin\Imagine\Image\Palette\Color\ColorInterface;
use Common\Plugin\Imagine\Image\Fill\FillInterface;
use Common\Plugin\Imagine\Image\Fill\Gradient\Horizontal;
use Common\Plugin\Imagine\Image\Fill\Gradient\Linear;
use Common\Plugin\Imagine\Image\Point;
use Common\Plugin\Imagine\Image\PointInterface;
use Common\Plugin\Imagine\Image\ProfileInterface;
use Common\Plugin\Imagine\Image\ImageInterface;
use Common\Plugin\Imagine\Image\Palette\PaletteInterface;
