...
namespace Common\Plugin\Imagine\Filter;

use Common\Plugin\Imagine\Exception\InvalidArgumentException;
use Common\Plugin\Imagine\Filter\Basic\ApplyMask;
use Common\Plugin\Imagine\Filter\Basic\Copy;
use Common\Plugin\Imagine\Filter\Basic\Crop;
use Common\Plugin\Imagine\Filter\Basic\Fill;
use Common\Plugin\Imagine\Filter\Basic\FlipVertically;
use Common\Plugin\Imagine\Filter\Basic\FlipHorizontally;
use Common\Plugin\Imagine\Filter\Basic\Paste;
use Common\Plugin\Imagine\Filter\Basic\Resize;
use Common\Plugin\Imagine\Filter\Basic\Rotate;
use Common\Plugin\Imagine\Filter\Basic\Save;
use Common\Plugin\Imagine\Filter\Basic\Show;
use Common\Plugin\Imagine\Filter\Basic\Strip;
use Common\Plugin\Imagine\Filter\Basic\Thumbnail;
...
use Common\Plugin\Imagine\Image\ManipulatorInterface;
